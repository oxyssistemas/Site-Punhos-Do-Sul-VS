        ...
        <div className="flex items-center justify-between h-20 sm:h-24 md:h-28">
          ...
          <nav className="hidden lg:flex items-center gap-5 xl:gap-7 font-chinese">
            ...
            <div className="flex items-center gap-2 pl-2 border-l border-red-900/50">
              ...
              <a
                id="social-header-tiktok"
                href={SITE_INFO.tiktokUrl}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="w-7 h-7 xl:w-8 xl:h-8 rounded-full bg-neutral-800/80 hover:bg-neutral-950 hover:text-cyan-400 text-gray-300 flex items-center justify-center transition-all border border-neutral-700 hover:border-cyan-400 shadow"
              >
